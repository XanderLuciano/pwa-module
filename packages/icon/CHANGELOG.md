...
<a name="0.2.2"></a>
## [0.2.2](https://github.com/XanderLuciano/pwa-module/compare/@ncviewer/icon@0.2.0...@ncviewer/icon@0.2.2) (2018-08-07)

**Note:** Version bump only for package @ncviewer/icon
...
* **icon:** await on build ([e3c1be2](https://github.com/XanderLuciano/pwa-module/commit/e3c1be2))
* **icon:** generate only on build ([9d68d70](https://github.com/XanderLuciano/pwa-module/commit/9d68d70))
...
* **icon:** add combined option sources ([539430f](https://github.com/XanderLuciano/pwa-module/commit/539430f))
