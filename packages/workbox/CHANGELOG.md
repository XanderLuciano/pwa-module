...
<a name="0.2.2"></a>
## [0.2.2](https://github.com/XanderLuciano/pwa-module/compare/@ncviewer/workbox@0.2.0...@ncviewer/workbox@0.2.2) (2018-08-07)

**Note:** Version bump only for package @ncviewer/workbox
...
* **workbox:** faster service worker register ([07524a2](https://github.com/XanderLuciano/pwa-module/commit/07524a2))
* **workbox:** make cacheId independent of npm package version ([b744a27](https://github.com/XanderLuciano/pwa-module/commit/b744a27))
* **workbox:** use regexp for runtimeCaching. fixes [#14](https://github.com/XanderLuciano/pwa-module/issues/14). ([f384103](https://github.com/XanderLuciano/pwa-module/commit/f384103))


### Features

* Add compatibility for nuxt 1.0.0 hooks ([c0efb1d](https://github.com/XanderLuciano/pwa-module/commit/c0efb1d))
* add option to register third-party sw ([#12](https://github.com/XanderLuciano/pwa-module/issues/12)) ([9c0b61e](https://github.com/XanderLuciano/pwa-module/commit/9c0b61e))
* **runtimeCaching:** Support runtimeCaching ([fdcda0f](https://github.com/XanderLuciano/pwa-module/commit/fdcda0f))
* Add support of StrategyOptions to cache ([b17bbd0](https://github.com/XanderLuciano/pwa-module/commit/b17bbd0))
* **worbox:** add offline option for making it optional ([#59](https://github.com/XanderLuciano/pwa-module/issues/59)) ([76de33c](https://github.com/XanderLuciano/pwa-module/commit/76de33c)), closes [#24](https://github.com/XanderLuciano/pwa-module/issues/24)
* **workbox:** add options.autoRegister ([f1e1fe1](https://github.com/XanderLuciano/pwa-module/commit/f1e1fe1))
* **workbox:** expose registration as window.$sw ([a5ddf59](https://github.com/XanderLuciano/pwa-module/commit/a5ddf59))
* **workbox:** importScripts option ([7c8644c](https://github.com/XanderLuciano/pwa-module/commit/7c8644c))
* **workbox:** rewrite with better template support ([b0af84e](https://github.com/XanderLuciano/pwa-module/commit/b0af84e))
